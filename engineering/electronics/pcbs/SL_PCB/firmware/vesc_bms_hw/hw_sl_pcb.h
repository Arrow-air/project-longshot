/*
    ...
    Copyright 2024 SL_PCB Contributors
...
#ifndef HWCONF_HW_SL_PCB_H_
#define HWCONF_HW_SL_PCB_H_

#define HW_NAME                 "SL_PCB"
...
#define HW_INIT_HOOK()          hw_sl_pcb_init()

void hw_sl_pcb_init(void);

#endif /* HWCONF_HW_SL_PCB_H_ */
