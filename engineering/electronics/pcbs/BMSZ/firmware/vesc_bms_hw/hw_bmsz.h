/*
    ...
    Copyright 2024 BMSZ Contributors
...
#ifndef HWCONF_HW_BMSZ_H_
#define HWCONF_HW_BMSZ_H_
...
#define HW_INIT_HOOK()          hw_bmsz_init()

void hw_bmsz_init(void);

#endif /* HWCONF_HW_BMSZ_H_ */
